	...
	<body background="i14.jpg">
		...
		<form method="post">
			<h1 style="margin-top:10%;  margin-left:25%;
				font-size:50px;">Check bills generated</h1>
				...
				if(isset($_POST['submit']))
				{
					...
					if($count > 0)
					{
						?>
							...
							<table style="width:80%;   margin-left:5%; border: ">
							 <caption>Bills generated Between Dates <?php echo $newdate ?> and <?php echo $newdate2 ?></caption>
									<tr>
										<th>Invoice no</th>
										<th>Customer name</th>
										<th>Total amount</th>
						...
						while($rows=mysqli_fetch_assoc($result))
						{
								...
								$v=$rows['sp'];
								?>
										<form method="post" target="leftframe" action ="m1_1.php">
										<tr>
					...
					else
					{
						?>
								...
								<script>						
								alert("No bills generated in this period");
								</script>
